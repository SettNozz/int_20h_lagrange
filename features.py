...
def create_hexagons(lat, lon): 
    ...
    latitudes1, latitudes2, latitudes3, latitudes4, latitudes5, latitudes6 = list(), list(), list(), list(), list(), list()
    longitudes1, longitudes2, longitudes3, longitudes4, longitudes5, longitudes6 = list(), list(), list(), list(), list(), list()
    hexagon_id = list()
